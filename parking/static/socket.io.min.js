...
!(function (t, n) {
        ...
        (r.onData = function (t) {
          ...
          (function (t, n) {
            ...
            if (
              ...
              return (
                n.onClose({ description: "transport closed by the server" }), !1
              );
            n.onPacket(t);
          }),
                      ...
                      transform: function (s, u) {
                        for (i.push(s); ; ) {
                          if (0 === r) {
                            ...
                            (e = v * Math.pow(2, 32) + a.getUint32(4)), (r = 3);
                          } else {
                            if (M(i) < e) break;
                            var l = x(i, e);
  ...
  var lt = (function (t) {
      ...
      return (
        ...
        (i.onHandshake = function (n) {
          (this.Z = this.nt(n.upgrades)), t.prototype.onHandshake.call(this, n);
        }),
        (i.nt = function (t) {
  ...
  function At(t) {
    var n = [],
      ...
      r = t;
    return (
      (r.data = jt(i, n)), (r.attachments = n.length), { packet: r, buffers: n }
    );
  }
  function jt(t, n) {
    if (!t) return t;
    if (mt(t)) {
      var i = { it: !0, num: n.length };
      return n.push(t), i;
    }
    if (Array.isArray(t)) {
      ...
      return (
        ...
        (o.connect = function () {
          return (
            this.connected ||
              (this.subEvents(),
              this.io.st || this.io.open(),
              "open" === this.io.ut && this.onopen()),
            this
          );
        }),
        (o.open = function () {
        ...
        (o.ht = function (t) {
          ...
          t.push(function (t) {
            if (r === i.rt[0]) {
              if (null !== t)
                r.tryCount > i.l.retries && (i.rt.shift(), n && n(t));
              else if ((i.rt.shift(), n)) {
                for (
        ...
        (o.ct = function () {
          var t =
            arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
          if (this.connected && 0 !== this.rt.length) {
            var n = this.rt[0];
            (n.pending && !t) ||
              ((n.pending = !0),
              n.tryCount++,
        ...
        (o.lt = function (t) {
          this.packet({
            type: Bt.CONNECT,
            data: this.dt ? e({ pid: this.dt, offset: this.yt }, t) : t,
          });
        }),
        ...
        (o.onAny = function (t) {
          return (this.wt = this.wt || []), this.wt.push(t), this;
        }),
        (o.prependAny = function (t) {
          return (this.wt = this.wt || []), this.wt.unshift(t), this;
        }),
        (o.offAny = function (t) {
          if (!this.wt) return this;
          if (t) {
            for (var n = this.wt, i = 0; i < n.length; i++)
        ...
        (o.onAnyOutgoing = function (t) {
          return (this.kt = this.kt || []), this.kt.push(t), this;
        }),
        (o.prependAnyOutgoing = function (t) {
          return (this.kt = this.kt || []), this.kt.unshift(t), this;
        }),
        (o.offAnyOutgoing = function (t) {
          if (!this.kt) return this;
          if (t) {
            for (var n = this.kt, i = 0; i < n.length; i++)
              if (t === n[i]) return n.splice(i, 1), this;
          } else this.kt = [];
          return this;
        }),
      ...
      return (
        (i.reconnection = function (t) {
          return arguments.length
            ? ((this.At = !!t), t || (this.skipReconnect = !0), this)
            : this.At;
        }),
        (i.reconnectionAttempts = function (t) {
          return void 0 === t ? this.jt : ((this.jt = t), this);
        }),
        ...
        (i.timeout = function (t) {
          return arguments.length ? ((this.St = t), this) : this.St;
        }),
        ...
        (i.open = function (t) {
          var n = this;
          if (~this.ut.indexOf("open")) return this;
          this.engine = new pt(this.uri, this.opts);
          var i = this.engine,
            r = this;
          (this.ut = "opening"), (this.skipReconnect = !1);
        ...
        (i.onopen = function () {
          this.cleanup(), (this.ut = "open"), this.emitReserved("open");
          var t = this.engine;
          this.subs.push(
        ...
        (i.onclose = function (t, n) {
          ...
          this.cleanup(),
            ...
            (this.ut = "closed"),
            this.emitReserved("close", t, n),
            this.At && !this.skipReconnect && this.reconnect();
        }),
        (i.reconnect = function () {
          var t = this;
          if (this.st || this.skipReconnect) return this;
          var n = this;
          if (this.backoff.attempts >= this.jt)
            this.backoff.reset(),
